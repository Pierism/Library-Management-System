...
$result = $conn->query($sql) or die($database->error);
...
<form method='post' action="process.php?update=true">
    ...
    <input type="text" id="member_id" name="member_id" value="<?= $row[0]; ?>" readonly><br><br>
    ...
    <input type="date" id="birthday" name="birthday" value="<?= $row[3]; ?>" required><br><br>
