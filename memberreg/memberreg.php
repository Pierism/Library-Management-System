...
<div class="container-fluid">
    ...
    <a href="admin.php" class="nav-link">
        <img src="university-of-kelaniya-logo.png" alt="Home" style="max-width: 100px; height: auto; animation: rotate 15s linear infinite;">
                ...
                <li class="nav-item">
                <a href="memberreg.php" class="nav-link">Member Registration</a>
        ...
        <?php if ($result->num_rows > 0) { ?>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td><?= $row['email'] ?></td>
                    <td>
                    <a href="member_update.php?member_id=<?= $row['member_id'] ?>"" class="updateBtn">Update</a>
                     <a href="process.php?delete=true&member_id=<?= htmlspecialchars($row['member_id']) ?>" class="deleteBtn" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a>
